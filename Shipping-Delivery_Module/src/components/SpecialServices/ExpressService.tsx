...
import { ChevronLeft, MoreHorizontal, ChevronRight, Store, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-[#F4F5F7] absolute inset-0 z-10 font-sans">
      ...
      <div className="bg-white flex items-center justify-between px-4 py-3 sticky top-0 z-20">
        ...
        <h1 className="text-[17px] font-bold text-gray-900">特快件</h1>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-3 pb-32">
        ...
        {/* BANNER XANH EXPRESS (Hình ảnh thuyền buồm) */}
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          <div className="font-bold text-gray-900 text-[15px] flex items-center mb-3">
            特快件 <span className="bg-orange-50 text-orange-500 text-[10px] px-1.5 py-0.5 rounded ml-2 font-normal border border-orange-100">普货</span>
          </div>
          <div className="w-full h-24 bg-gradient-to-r from-[#90C8E0] via-[#5C9ECA] to-[#1E6B9E] rounded-xl flex flex-col justify-center pl-6 shadow-inner relative overflow-hidden">
             <div className="z-10 text-white font-bold text-xl italic tracking-wider drop-shadow-md">联手顺丰速运 <span className="text-xs rounded-full border border-white px-1.5 ml-1 not-italic">SF</span></div>
             <div className="z-10 text-white/80 text-[11px] mt-1 tracking-widest">定义物流新时代</div>
             <div className="absolute right-4 bottom-2 text-5xl opacity-80 drop-shadow-lg">⛵</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          ...
          {/* Nút Radio Có chụp ảnh không (CHI TIẾT BỊ THIẾU LẦN TRƯỚC ĐÃ THÊM VÀO) */}
